      ...
      <div class="login_wrapper">
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form>
              <h1>Bantuan</h1>
              <p>Untuk demo aplikasi silahkan masukkan username : <strong>admin</strong> password : <strong>adminadmin</strong><br>Untuk informasi lebih lanjut silahkan hubungi <strong>noyarichardo@gmail.com</strong></p>
