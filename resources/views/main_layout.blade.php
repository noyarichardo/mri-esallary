...
<html lang="en">
  <head>
    ...
    <!-- alertify -->
    <link rel="stylesheet" href="{{ asset('vendors/alertify/css/alertify.css') }}">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/" class="site_title"> <span>E-Salary</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{ asset('images/profile-user.png') }}" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="masterFormPegawai" class="row" style="display:none">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form onsubmit="false" action="{{ route('tambahPegawai') }}" method="post" id="idForm" class="form-horizontal form-label-left idForm" novalidate>
            ...
            <div id="masterEditPegawai" class="row" style="display:none">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form onsubmit="false" action="{{ route('tambahPegawai') }}" method="post" id="form_edit" class="form-horizontal form-label-left" novalidate>
                      <div class="item form-group">
        ...
        <footer>
          <div class="pull-right">
            E-Salary - Sistem Penggajian © 2022
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <!-- alertifi -->
    <script src="{{ asset('vendors/alertify/js/alertify.js') }}" charset="utf-8"></script>
    ...
    $("#form_absensi").submit(function(e) {
        ...
        if (validator.checkAll($(this))) {
            var url = "{{ route('absen') }}"; // the script where you handle the form input.
    ...
    $('#form_edit').submit(function(e){
        // evaluate the form using generic validaing
        if (validator.checkAll($(this))) {
            var url = "{{ route('editPegawai') }}"; // the script where you handle the form input.
    ...
    $('#idForm').submit(function(e) {
        // evaluate the form using generic validaing
        if (validator.checkAll($(this))) {
            var url = "{{ route('tambahPegawai') }}"; // the script where you handle the form input.
