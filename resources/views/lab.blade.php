...
<html>
  ...
  <body>
    <div class="container">
      ...
      <div class="baris garis-bawah" style="padding-left:15px;padding-right:15px;">
        <div class="sepertiga">
          <div class="baris">Information System Solution</div>
          <div class="baris">Jl. Mampang Prapatan No. 67A</div>
          <div class="baris">TELP. (021) 3095786</div>
        </div>
        <div class="sepertiga">
